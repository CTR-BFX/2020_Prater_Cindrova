...
genes_ht_ER <- c("ERP44","ANK1","HSPA5","HERPUD1","KIF2A","FCGR2B","DNAJB11","DNAJC3","TUSC3","AREG","MAN1C1","SDF2L1","DNAJB9","PDIA6","MANF","HYOU1","KIF5A","TGFA","SPTA1","HSP90B1","PDIA3","HSPA6","GOLT1A","CALR","MCFD2","SSR4","GAS6","PROS1","PDIA2","LRRK2","SERPINA1","ERO1A","MAN1A2","SCAMP5","FICD","XBP1","LMAN1", "ERN1", "XBP1","EIF2AK3" ) # "LMAN1L", "EDEM2", ¢ rm: ,"THBS1","ANK2","SRPX",
...
genes_ht_oxy <- c("TBXAS1","ADCY2","EDN1","ICAM1","RGCC","TRPA1","CCL2","NCF2","CCR7","KLF2","CBFA2T3","HBZ","IL10","TLR2","CH25H","CYP1A1","CYP1A2","PKLR","KCNMB1","GUCY1A2","KCNMA1","NCF1","GDNF","TLR6","LEP","APOLD1","PENK","MAFA","CYP2R1","MAPT","P2RX2","DPYD","HBG2","SLC30A10","HIF3A","ANG","COX4I2","SOD3","GPX1", "NOS1AP", "CAT") # rm 1 "SESN3", "AKR1D1","APOD",
genes_ht_WNT <-c("DKK3","CDK14","LRP6","TNRC6C","PORCN","FGF9","WNT2","WNT5B","TBX18","IGFBP2","SDC1","WNT1","APOE","PDE6B","WNT10A","TLR2","PLCB2","LEF1","NKD1","ARRB2","IGFBP4","NKD2","DCDC2","RSPO3","DRD2","PTPRO","WNT3A","PSMA8","APCDD1","DKK2","EDA","PRKAA2","ZEB2","CTNND2","WNT10B","CDH2","SOX7","LRRK2","PSMB8","PSMB9", "WNT7A", "WNT9B", "RYR2", "CCND1", "NR4A2", "LEF1") # remove: "RECK","LYPD6","DAAM2","ZBED3","SCEL","NRARP",
genes_ht_cellcycl <-c("MLXIPL","FHL1","FOXC1","DUSP13","PTPRC","ABCB1","CDKL1","FAM83D","RGCC","TUBB4A","LILRB1","RASSF4","CCL2","HYAL1","PLAGL1","TEX14","INHBA","ESX1","INHA","IL10","CGREF1","CYP1A1","MAPK4","PRKACB","HMGA2","PPP1R1C","PPP2R2B","PYHIN1","GEM","GFI1B","FAM107A","AFAP1L2","WNT10B","LEP","RNF212","GAS6","EVI2B","PSMB8","AIF1","SPDYC","GMNC","PSMB9","TUBB3","SMIM22","TGFB1", "GKN1") # "TEX11",
...
genes_hormone <-c("RORC","SPX","CGA","LEP","CGB2","INHA","CGB5","NR2F1","CGB8","FBN1","PENK","CGB7","CGB3","IGF1","KL","LHB","INSL4","EDN1","METRN","CGB1","RARB","INHBA","PTH2R","GPER1","CSH1","ERFE","GUCA2A","STC1","CSHL1","TTR","RLN1","UTS2B","CRH","NPPB","RXRG","PGR","EPO","NR4A2","EDN2","EGFR", "HCRTR2", "CRYM","FSHR") # ,"AMHR2","SLC16A2","SLC16A10","NR6A1","OR51E2","HAMP",
...
ht_hormone  <- makeHeatmap(genes_hormone,    name_of_heatmap= "genes_hormone",     by_cellType = FALSE)
...
ht_lipid_transport  <- makeHeatmap(genes_Lipid_Transport$external_gene_name,    name_of_heatmap= "genes_lipidTransport",     by_cellType = TRUE)
...
genes_ECM_selected <- subset(genes_ECM_selected, abs(genes_ECM_selected$log2FoldChange) > l2fcx)
